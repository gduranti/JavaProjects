...
public class TestesAvaliador2 {
	...
	public void testes() throws Exception {
		testInserirAvaliadorSemNome();
		testInserirAvaliadorSemCpf();
		testInserirAvaliadorComSucesso();
		testExcluirAvaliadorComSucesso();
	}
	...
	public void testExcluirAvaliadorComSucesso() throws Exception {
		...
		FluentWait<WebDriver> wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.visibilityOf(avaliadorPage.getMessagemGeral()));
		assertEquals("Avaliador excluído com sucesso erro", avaliadorPage.getMessagemGeral().getText());
